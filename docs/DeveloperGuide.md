...
- [Developer Guide - Ledger 67](#developer-guide---ledger-67)
  ...
  - [3. Implementation Details](#3-implementation-details)
    ...
    - [3.2 Updated Transaction Data Model](#32-updated-transaction-data-model)
      ...
      - [3.2.3 Class Diagram for Core Data Model](#323-class-diagram-for-core-data-model)
    - [3.3 Storage Feature](#33-storage-feature)
      - [3.3.1 Transaction Persistence](#331-transaction-persistence)
      - [3.3.2 Loading Transactions](#332-loading-transactions)
      - [3.3.3 Data Encoding and Decoding](#333-data-encoding-and-decoding)
      - [3.3.4 Integration with TransactionsList](#334-integration-with-transactionslist)
      - [3.3.5 Design Considerations](#335-design-considerations)
      - [3.3.6 Sequence Diagram](#336-sequence-diagram)
    - [3.4 Currency Conversion Feature](#34-currency-conversion-feature)
      - [3.4.1 Integration with Architecture](#341-integration-with-architecture)
      - [3.4.2 Simple Currency Conversion](#342-simple-currency-conversion)
      - [3.4.3 Exchange Rate Storage](#343-exchange-rate-storage)
      - [3.4.4 Live Exchange Rate Integration](#344-live-exchange-rate-integration)
      - [3.4.5 Conversion of Stored Transactions](#345-conversion-of-stored-transactions)
      - [3.4.6 Display Currency Conversion (List View)](#346-display-currency-conversion-list-view)
      - [3.4.7 Design Considerations](#347-design-considerations)
      - [3.4.8 Sequence Diagram](#348-sequence-diagram)
    - [3.5 Confirm and Store Converted Transactions](#35-confirm-and-store-converted-transactions)
      - [3.5.1 Implementation Details](#351-implementation-details)
      - [3.5.2 Workflow](#352-workflow)
        - [Case 1: `convert transaction`](#case-1-convert-transaction)
        - [Case 2: `list -to`](#case-2-list--to)
    ...
    - [3.6 Transaction Presets Feature](#36-transaction-presets-feature)
      - [3.6.1 Implementation Details:](#361-implementation-details)
      - [3.6.1 Workflow:](#361-workflow)
      - [3.6.2 Design Considerations](#362-design-considerations)
      - [3.6.3 Alternatives Considered](#363-alternatives-considered)
    - [3.7 Balance Sheet Feature](#37-balance-sheet-feature)
      - [3.7.1 Integration with Architecture](#371-integration-with-architecture)
      - [3.7.2 Command Handling](#372-command-handling)
      - [3.7.3 Balance Aggregation Logic](#373-balance-aggregation-logic)
        - [3.7.4 Workflow:](#374-workflow)
      - [3.7.5 Hierarchical Account Support](#375-hierarchical-account-support)
      - [3.7.6 Income and Expense Handling](#376-income-and-expense-handling)
      - [3.7.7 Currency Conversion](#377-currency-conversion)
      - [3.7.8 Output Formatting](#378-output-formatting)
      - [3.7.9 CSV Export](#379-csv-export)
    ...
    - [3.9 Hierarchical Account Registry & Filtering Feature](#39-hierarchical-account-registry--filtering-feature)
      ...
      - [3.9.4 Sequence Diagram](#394-sequence-diagram)
    - [3.10 Quality Assurance and Logging Enhancements](#310-quality-assurance-and-logging-enhancements)
      - [3.10.1 Enhanced Logging System](#3101-enhanced-logging-system)
      - [3.10.2 Enhanced Error Recovery and Validation](#3102-enhanced-error-recovery-and-validation)
      - [3.10.3 Enhanced Testing Framework](#3103-enhanced-testing-framework)
      - [3.10.4 Code Quality Metrics and Automation](#3104-code-quality-metrics-and-automation)
      - [3.10.5 Build System Enhancements](#3105-build-system-enhancements)
      - [3.10.6 Design Considerations](#3106-design-considerations)
      - [3.10.7 Impact on Development Process](#3107-impact-on-development-process)
    - [3.11 UI Improvements and Assistance](#311-ui-improvements-and-assistance)
      - [3.11.1 Implementation Details](#3111-implementation-details)
      - [3.11.2 Design Considerations](#3112-design-considerations)
      - [3.11.3 Alternatives Considered](#3113-alternatives-considered)
    - [3.12 Documentation and User Experience Improvements](#312-documentation-and-user-experience-improvements)
      - [3.12.1 User Guide Rewrite and Enhancement](#3121-user-guide-rewrite-and-enhancement)
      - [3.12.2 Help Command Implementation](#3122-help-command-implementation)
      - [3.12.3 Documentation Maintenance and Currency Feature Updates](#3123-documentation-maintenance-and-currency-feature-updates)
      - [3.12.4 Design Considerations](#3124-design-considerations)
      - [3.12.5 Impact on User Experience](#3125-impact-on-user-experience)
  ...
  - [8. Appendix E: Instructions for Manual Testing](#8-appendix-e-instructions-for-manual-testing)
    - [8.1 Launching the Application](#81-launching-the-application)
    - [8.2 Adding Transactions](#82-adding-transactions)
    - [8.3 Validation of Minimum Postings](#83-validation-of-minimum-postings)
    - [8.4 Listing and Filtering](#84-listing-and-filtering)
    - [8.5 Editing Transactions](#85-editing-transactions)
    - [8.6 Deleting Transactions](#86-deleting-transactions)
    - [8.7 Currency Conversion](#87-currency-conversion)
    - [8.8 Confirm Feature](#88-confirm-feature)
    - [8.9 List Conversion (View Only)](#89-list-conversion-view-only)
    - [8.10 Balance Sheet](#810-balance-sheet)
    - [8.11 Monetary Precision (Rounding)](#811-monetary-precision-rounding)
    - [8.12 UI Assist Mode](#812-ui-assist-mode)
    - [8.13 Edge Cases](#813-edge-cases)
    - [8.14 Notes for Testers](#814-notes-for-testers)
